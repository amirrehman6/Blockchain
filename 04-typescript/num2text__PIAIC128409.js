...
var numString = '12345678912';
var textString = "";
numString = parseInt(numString).toString();
// FUNCTION DECLARATION
function num2text(numString) {
    ...
    var text_1 = { 1: 'one', 2: 'two', 3: 'three', 4: 'four', 5: 'five', 6: 'six', 7: 'seven', 8: 'eight', 9: 'nine' };
    var text_2 = { 0: 'ten', 1: 'eleven', 2: 'twelve', 3: 'thirteen', 4: 'fourteen', 5: 'fifteen', 6: 'sixteen', 7: 'seventeen', 8: 'eighteen', 9: 'ninteen' };
    var text_3 = { 1: 'ten', 2: 'twenty', 3: 'thirty', 4: 'forty', 5: 'fifty', 6: 'sixty', 7: 'seventy', 8: 'eighty', 9: 'ninety' };
    var text_4 = { 1: '', 2: 'thousand', 3: 'million', 4: 'billion', 5: 'trillion', 6: 'quadrillion', 7: 'quintillion', 8: 'sextillion', 9: 'Septillion' };
